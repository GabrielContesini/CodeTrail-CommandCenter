        ...
        <AreaChart data={data}>
          <defs>
            <linearGradient id="sessionsFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#63b3ff" stopOpacity={0.34} />
              <stop offset="100%" stopColor="#63b3ff" stopOpacity={0.02} />
            </linearGradient>
            <linearGradient id="syncFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#7fffd3" stopOpacity={0.26} />
              <stop offset="100%" stopColor="#7fffd3" stopOpacity={0.02} />
            </linearGradient>
          </defs>
