        ...
        <GlassCard className="p-6">
         ...
         <GlassCard className="p-6">
           <StatCard
             ...
             value={queue ? formatCompactNumber(queue.rowCount) : "0"}
             delta={queue ? (queue.health === "healthy" ? "Dentro do esperado" : "Acima do esperado") : "Vazio"}
             deltaColor={queue && queue.health === "healthy" ? "emerald" : queue ? "amber" : "emerald"}
             progressPercent={queue ? (queue.health === "healthy" ? 40 : 80) : 10}
           />
         </GlassCard>
         <GlassCard className="p-6">
           <StatCard
             ...
             progressPercent={Math.round((healthyTables / snapshot.database.length) * 100)}
           />
         </GlassCard>
         <GlassCard className="p-6">
           <StatCard
